...
{/* 
      <section className='w-full flex flex-col items-center'>
        <div className='w-[80%] flex flex-col items-center gap-6'>
          <p className='text-4xl font-semibold text-green-500'>Our team</p>
          <p className='font-semibold'>Our people mean the world to us</p>
          <div className='grid grid-cols-4 justify-center gap-6'>
            <div className='w-[261px] flex flex-col items-center group'>
              <div className='rounded-lg bg-[#f8f8f8] group-hover:hidden'>
                <div className='bg-[#fbc244] rounded-md'>
                  <img src={janak_bhatt} alt="" className='rounded-md' />
                </div>
                <div className='my-4 flex flex-col items-center'>
                  <p className='font-semibold'>Janak Bhatt</p>
                  <p>Chief Executive Officer</p>
                </div>
              </div>
              <div className='w-full p-8 text-white hidden rounded-lg hover:bg-green-500 group-hover:block'>
                <div>
                  <p className='font-semibold text-xl'>Janak Bhatt</p>
                  <p className='pb-2 font-semibold text-lg'>CEO</p>
                  <p className='font-medium'>He leads the strategic vision and overall direction of the company, leveraging his expertise and 2 years of experience to drive its growth and success.</p>
                </div>
            ...
            <div className='w-[261px] flex flex-col items-center group'>
              <div className='rounded-lg bg-[#f8f8f8] group-hover:hidden'>
                <div className='bg-[#ecb6ea] rounded-md'>
                  <img src={rajendra_bhatt} alt="" className='rounded-md' />
                </div>
                <div className=' my-4 flex flex-col items-center'>
                  <p className='font-semibold'>Rajendra Bhatt</p>
                  <p>Chief Business Development Officer</p>
                </div>
              </div>
              <div className='w-full p-8 pb-2 text-white hidden rounded-lg hover:bg-green-500 group-hover:block'>
                <div>
                  <p className='font-semibold text-xl'>Rajendra Bhatt</p>
                  <p className='pb-2 font-semibold text-lg'>CBDO</p>
                  <p className='font-medium'>He Spearheads strategic partnerships ans business development, fosterinng growth ans client relationships, backed by 5 years of invaluable expertise in markering and business development.</p>
                </div>
                <div className='mt-4 flex justify-end'>
                  <FaLinkedin className='text-3xl' />
                </div>
            ...
            <div className='w-[261px] flex flex-col items-center group'>
              <div className='rounded-lg bg-[#f8f8f8] group-hover:hidden'>
                <div className='bg-[#f6c586] rounded-md'>
                  <img src={manojBudhaAyer} alt="" className='w-[261px] h-[261px] rounded-md' />
                </div>
                <div className='my-4 flex flex-col items-center'>
                  <p className='font-semibold'>Manoj Budha Ayer</p>
                  <p>Chief Digital Marketing Officer</p>
                </div>
              </div>
              <div className='w-full p-8 text-white hidden rounded-lg hover:bg-green-500 group-hover:block'>
                <div>
                  <p className='font-semibold text-xl'>Manoj Budha Ayer</p>
                  <p className='pb-2 font-semibold text-lg'>CDMO</p>
                  <p className='font-medium'>He leads comperhensive strategies for brand growth, merging technical development and digital marketing, with 4 years of hands-on experience im both domains.</p>
                </div>
                <div className='mt-4 flex justify-end'>
                  <FaLinkedin className='text-3xl' />
                </div>
            ...
            <div className='w-[261px] flex flex-col items-center group'>
              <div className='rounded-lg bg-[#f8f8f8] group-hover:hidden'>
                <div className='bg-[#baa4ee] rounded-md'>
                  <img src={ganeshojha} alt="" className='w-[261px] h-[261px] rounded-md' />
                </div>
                <div className='my-4 flex flex-col items-center'>
                  <p className='font-semibold'>Ganesh Raj Ojha</p>
                  <p>Chief Administrative Officer</p>
                </div>
              </div>
              <div className='w-full p-8 text-white hidden rounded-lg hover:bg-green-500 group-hover:block'>
                <div>
                  <p className='font-semibold text-xl'>Ganesh Raj Ojha</p>
                  <p className='pb-2 font-semibold text-lg'>CAO</p>
                  <p className='font-medium'>He obersees administrative operations, optimizing organizational efficiency as Neem Infosys's CAO, bringing 4 years of seasoned experience in administrative roles for operational excellence.</p>
                </div>
                <div className='mt-4 flex justify-end'>
                  <FaLinkedin className='text-3xl' />
                </div>
            ...
            <div className='w-[261px] flex flex-col items-center group'>
              <div className='rounded-lg bg-[#f8f8f8] group-hover:hidden'>
                <div className='bg-[#baa4ee] rounded-md'>
                  <img src={team_niraj_pal} alt="" className='rounded-md' />
                </div>
                <div className='my-4 flex flex-col items-center'>
                  <p className='font-semibold'>Niraj Pal</p>
                  <p>Chief Technology Officer</p>
                </div>
              </div>
              <div className='w-full p-8 text-white hidden rounded-lg hover:bg-green-500 group-hover:block'>
                <div>
                  <p className='font-semibold text-xl'>Niraj Pal</p>
                  <p className='pb-2 font-semibold text-lg'>CTO</p>
                  <p className='font-medium'>He drive overall business straregy and growth, leveraging three years of Software Engineering expertise to lead technology innovation and development.</p>
                </div>
                <div className='mt-4 flex justify-end'>
                  <FaLinkedin className='text-3xl' />
                </div>
            ...
            <div className='w-[261px] flex flex-col items-center group'>
              <div className='rounded-lg bg-[#f8f8f8] group-hover:hidden'>
                <div className='bg-[#baa4ee] rounded-md'>
                  <img src={team_roshan} alt="" className='rounded-md' />
                </div>
                <div className='my-4 flex flex-col items-center'>
                  <p className='font-semibold'>Roshan Bist</p>
                  <p>Web Developer</p>
                </div>
              </div>
              <div className='w-full p-8 text-white hidden rounded-lg hover:bg-green-500 group-hover:block'>
                <div>
                  <p className='font-semibold text-xl'>Roshan Bist</p>
                  <p className='pb-2 font-semibold text-lg'>Web Developer</p>
                  <p className='font-medium'>Roshan is forntend web designer and wordpress developer at Neem Ingosys.</p>
                </div>
                <div className='mt-4 flex justify-end'>
                  <FaLinkedin className='text-3xl' />
                </div>
            ...
            <div className='w-[261px] flex flex-col items-center group'>
              <div className='rounded-lg bg-[#f8f8f8] group-hover:hidden'>
                <div className='bg-[#e9a28a] rounded-md'>
                  <img src={team_bikram_basnet} alt="" className='rounded-md' />
                </div>
                <div className='my-4 flex flex-col items-center'>
                  <p className='font-semibold'>Bikram Basnet</p>
                  <p>Sr. Graphic Designer</p>
                </div>
              </div>
              <div className='w-full p-8 text-white hidden rounded-lg hover:bg-green-500 group-hover:block'>
                <div>
                  <p className='font-semibold text-xl'>Bikram Basnet</p>
                  <p className='pb-2 font-semibold text-lg'>Sr. Graphic Designer</p>
                  <p className='font-medium'>Bikram is talented and creative senior graphic designet at Neem Ingosys.</p>
                </div>
                <div className='mt-4 flex justify-end'>
                  <FaLinkedin className='text-3xl' />
                </div>
...
//             <p className='text-5xl font-semibold'> <span className='text-green-500'>Neem</span> <span className='text-[#808285]'>Infosys</span></p>
//             <p>Neem Infosys is a full-service IT Company at Mahendranagar, Nepal. We develop user-centric website, web apps and Digital Marketing that grows startup and existing businesses in the sales and service industries.</p>
//             <Button text="Get Free Consultation" />
//           </div>
//           <div className='w-[50%]'>
//             <img src={about_breadcrumb} alt="" />
//           </div>
//         </div>
//       </section>
...
//           <p className='text-green-500 font-semibold'>“Our success is measured by your success”</p>
...
//             <p className='text-4xl font-semibold text-green-500'>35+</p>
//             <p className='text-[#808285]'>Website Design</p>
//           </div>
//           <div className='flex flex-col items-center'>
//             <p className='text-4xl font-semibold text-green-500'>200+</p>
//             <p className='text-[#808285]'>Social Media Clients</p>
//           </div>
//           <div className='flex flex-col items-center'>
//             <p className='text-4xl font-semibold text-green-500'>15+</p>
//             <p className='text-[#808285]'>Team Member</p>
//           </div>
//           <div className='flex flex-col items-center'>
//             <p className='text-4xl font-semibold text-green-500'>3+</p>
//             <p className='text-[#808285]'>Web Products</p>
//           </div>
//         </div>
//       </section>
//       <section className='w-full bg-[#e8f1e9] pt-14 flex flex-col items-center'>
...
//           <div className='w-[50%]'>
//             <p>OUR MISSION</p>
//             <p>Easy solution, reasonable price and speedy job</p>
//             <ul className='list-disc pl-5'>
//               <li>To put effort towards realizing a digital ideal. Each and every company, no matter how big or little, starts with a dream. In the end, having a dream -or, as we prefer to refer to it, "passion for the goal" -is a need.</li>
//               <li>To provide them with the necessary tools so they can grow their business, stand out from the competition, and do more than just survive.</li>
//               <li>We're on a mission to connect as many talented people as possible to create meaningful work where together we can learn, earn and serve our way to becoming leaders worth following.</li>
//             </ul>
//           </div>
//         </div>
//         <div></div>
...
//               <span className='text-green-500'>Neem</span> <span className='text-[#808285]'>Infosys</span>
//             </p>
...
//               <p className='text-4xl font-semibold text-green-500'>{milestone.count}</p>
...
//               <p className='text-4xl font-semibold text-green-500'>Easy solution, reasonable price and speedy job</p>
...
//               <p className='text-4xl font-semibold text-green-500'>Innovation, Reliability, and Exceptional Customer Service.</p>
//               <ul className='list-disc pl-5 px-6 flex flex-col gap-4'>
...
//             <div className='w-[261px] rounded-md flex flex-col items-center bg-green-500'>
//               <div className='bg-[#f8f8f8]'> {/* if user hover it parent div then this div will hide */}
//                 <div className='bg-[#fbc244] rounded-md'>
//                   <img src={janak_bhatt} alt="" className='rounded-md' />
//                 </div>
//                 <div className='flex flex-col items-center'>
...
//                 </div>
//               </div>
//               <div className='w-full p-4 text-white'> {/* if user hover it parent div then this div will show */}
//                 <p>Janak Bhatt</p>
//                 <p>CEO</p>
//                 <p>He leads the strategic vision and overall direction of the company, leceraging his expertise ans 2 years of experience to drive its growth and success.</p>
//               </div>
//             </div>
//           </div>
//         </div>
...
//           <p className='font-semibold'>Our people mean the world to us</p>
//           <div className='grid grid-cols-4 gap-6'>
//             <div className='w-[261px] rounded-md flex flex-col items-center bg-green-500 group'>
//               <div className='bg-[#f8f8f8] group-hover:hidden'>
//                 <div className='bg-[#fbc244] rounded-md'>
//                   <img src={janak_bhatt} alt="" className='rounded-md' />
//                 </div>
//                 <div className='flex flex-col items-center'>
...
//                 </div>
//               </div>
//               <div className='w-full p-4 text-white hidden group-hover:block'> 
//                 <p className='font-semibold text-xl'>Janak Bhatt</p> {/* i want among siblings p tags */}
...
//                 </div>
//                 <div className='flex flex-col items-center'>
//                   <p className='font-semibold'>Rajendra Parsad Bhatt</p>
//                   <p>Chief Business Development Officer</p>
//                 </div>
//               </div>
//               <div className='w-full p-4 text-white hidden group-hover:block'>
//                 <p className='font-semibold text-xl'>Rajendra Parsad Bhatt</p> {/* i want among siblings p tags */}
//                 <p className='font-semibold text-lg'>CBDO</p>
//                 <p className='font-medium'>He spearheads strategic partnerships ans business development, fosterinng growth ans client relationships, backed by 5 years of invaluable expertise in markering and business development.</p>
//               </div>
//             </div>
//           </div>
    ...
    <div>
      ...
      <section className='w-full flex flex-col items-center'>
        <div className='w-[80%] flex flex-col items-center gap-6'>
          <p className='text-4xl font-semibold text-green-500'>Our team</p>
          <p className='font-semibold'>Our people mean the world to us</p>
          <div className='grid grid-cols-4 justify-center gap-6'> {/* make its children div center */}
