...
function Home() {
  return (
    <div className='relative'>
          ...
          <div className='md:w-[50%] w-[100%] py-12 flex flex-col gap-8'>
            <h1 className='text-5xl font-semibold flex flex-col items-center lg:items-start gap-2'>
              <p>
                ...
                <span className='text-green-500'> Idea’s </span>
              </p>
              <p>
                <span> Your </span>
      ...
      <section className='lg:px-32 md:px-10 px-2 relative top-52 bg-green-500'>
      ...
      <section>
        <div className='mt-52 lg:px-32 md:px-10 px-2 pt-12 flex justify-between'>
          ...
          <div className='shadow-[0px_4px_10px_-4px_rgba(0,0,0,0.3),-4px_0px_10px_-4px_rgba(0,0,0,0.3),4px_0px_10px_-4px_rgba(0,0,0,0.3)]'>
            <div className='w-[217px] h-[164px] flex justify-center items-center bg-green-500'>
        ...
        <div className='w-[70%] rounded-lg bg-[#dee0e5] ps-8 py-2 pe-2 flex gap-8'>
          <div className='w-[60%] py-6 flex flex-col gap-8'>
            <div className='text-5xl font-semibold flex flex-col gap-6'>
              <p> <span className='text-green-500'>Let’s Build</span> <span>the Future of</span></p>
            ...
            <div>
              <WhiteBGButton bgColor='bg-white' borderColor="border-white" hoverBgColor="bg-[#444444]" text="Get Free Conculation" hoverIconBgColor="bg-green-500" iconBgColor='bg-green-500' iconColor="text-white" groupHoverIconColor="text-white" />
            </div>
          </div>
          <div className='w-[40%]'>
            ...
            <div className='w-[50%] flex items-center gap-4 p-4 rounded-lg bg-[#e6ebf1]'>
              ...
              <div className='flex flex-col gap-3'>
                <div className='flex flex-col gap-3 font-medium'>
                  <p className='text-green-500'>2 Feb 2024</p>
                  <p>Top 7 Benefits of Investing in Enterprise Software Development!</p>
                </div>
                <div>
                  <WhiteBGButton bgColor='bg-white' borderColor="border-white" hoverBgColor="bg-[#444444]" text="Read More" hoverIconBgColor="bg-green-500" iconBgColor='bg-green-500' iconColor="text-white" groupHoverIconColor="text-white" />
                </div>
              </div>
            </div>
