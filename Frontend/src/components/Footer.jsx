...
// function Footer() {
//     return (
//         <div className='bg-[#222222] h-full flex flex-col items-center gap-8'>
//             <div className='flex flex-wrap xl:justify-evenly'>
//                 <div className='xl:w-[357px] lg:w-[332px] flex flex-col items-center gap-2'>
//                     <p className='text-white text-2xl font-semibold'>Neem Group</p>
...
//                 <div className='xl:w-[357px] lg:w-[332px] text-white flex flex-col gap-4'>
...
//                 <div className='xl:w-[250px] lg:w-[421px] mt-8 text-white flex flex-col gap-4'>
...
//                         <input type="submit" placeholder='Send' className='w-[63px] h-[40px] cursor-pointer text-white text-center rounded-e-md bg-green-500' />
//                     </form>
//                     <p>Your mail and other information are confidential.</p>
...
//                 </div>
//             </div>
//             <hr className='xl:w-[1116px] h-[2px]' />
