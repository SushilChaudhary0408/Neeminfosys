...
//                 <p className='text-lg text-center font-medium'>More the years, the better the solutions! We have been partnering with brands and offering our expertise for more than a decade.</p>
//             </div>
//             <div className='w-full flex gap-8 '>
//                 <div className='w-[50%] flex justify-center'>
//                     <div className='w-[60%] flex justify-center'>
//                         <video src={man_animation_video}></video>
//                     </div>
//                 </div>
//                 <div className='w-[50%] flex flex-col gap-6 '>
//                     <div className='p-4 group rounded-lg hover:bg-green-500 flex gap-2 shadow-[0px_4px_10px_-4px_rgba(0,0,0,0.3),-4px_0px_10px_-4px_rgba(0,0,0,0.3),4px_0px_10px_-4px_rgba(0,0,0,0.3)]'>
//                         <div className='w-[10%] group flex justify-center'>
//                             <div className='w-6 h-6 text-white group-hover:text-green-500 rounded-full bg-green-500 group-hover:bg-white flex justify-center items-center'>
//                                 <FaCheck />
//                             </div>
//                         </div>
    ...
    return (
        <div className='w-[80%] flex flex-col items-center justify-center gap-6'>
            ...
            <div className='w-full flex gap-8'>
                ...
                <div className='w-[50%] flex flex-col gap-6'>
                    {[...Array(4)].map((_, index) => (
                        <div key={index} className='p-4 group rounded-lg hover:bg-green-500 flex gap-2 shadow-[0px_4px_10px_-4px_rgba(0,0,0,0.3),-4px_0px_10px_-4px_rgba(0,0,0,0.3),4px_0px_10px_-4px_rgba(0,0,0,0.3)]'>
                            <div className='w-[10%] group flex justify-center'>
                                <div className='w-6 h-6 text-white group-hover:text-green-500 rounded-full bg-green-500 group-hover:bg-white flex justify-center items-center'>
                                    <FaCheck />
                                </div>
