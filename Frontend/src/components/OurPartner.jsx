...
// import Brahma_upvc from '../../public/images/brahma upvc.png';
...
//                 <div className='w-[168px] h-[168px] p-[35px] border border-[#e1e2e4] flex justify-center items-center'>
//                     <img src={sudurpashchim_upvc} alt="" />
//                 </div>
//                 <div className='w-[168px] h-[168px] p-[35px] border border-[#e1e2e4] flex justify-center items-center'>
//                     <img src={jai_siddha_baba} alt="" />
//                 </div>
//                 <div className='w-[168px] h-[168px] p-[35px] border border-[#e1e2e4] flex justify-center items-center'>
//                     <img src={Brahma_upvc} alt="" />
//                 </div>
//                 <div className='w-[168px] h-[168px] p-[35px] border border-[#e1e2e4] flex justify-center items-center'>
//                     <img src={timber_group_logo} alt="" />
//                 </div>
//                 <div className='w-[168px] h-[168px] p-[35px] border border-[#e1e2e4] flex justify-center items-center'>
//                     <img src={Planet_VT} alt="" />
//                 </div>
//                 <div className='w-[168px] h-[168px] p-[35px] border border-[#e1e2e4] flex justify-center items-center'>
//                     <img src={rcit_logo} alt="" />
//                 </div>
...
//                 <div className='w-[168px] h-[168px] p-[35px] border border-[#e1e2e4] flex justify-center items-center'>
//                     <img src={Kakalu_mart} alt="" />
//                 </div>
//                 <div className='w-[168px] h-[168px] p-[35px] border border-[#e1e2e4] flex justify-center items-center'>
//                     <img src={sagarmatha_choudhary_eye_hospital_logo} alt="" />
//                 </div>
//                 <div className='w-[168px] h-[168px] p-[35px] border border-[#e1e2e4] flex justify-center items-center'>
//                     <img src={powerpointnepal_logo} alt="" />
//                 </div>
//                 <div className='w-[168px] h-[168px] p-[35px] border border-[#e1e2e4] flex justify-center items-center'>
//                     <img src={dstourstravels_logo} alt="" />
//                 </div>
//                 <div className='w-[168px] h-[168px] p-[35px] border border-[#e1e2e4] flex justify-center items-center'>
//                     <img src={academycambridgeeducation_logo} alt="" />
//                 </div>
//                 <div className='w-[168px] h-[168px] p-[35px] border border-[#e1e2e4] flex justify-center items-center'>
//                     <img src={brmraramasala_logo} alt="" />
//                 </div>
//             </div>
//         </div>
//     )
