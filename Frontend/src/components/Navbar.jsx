...
function Navbar() {
    ...
    return (
        <div className="sticky top-0 z-10 border-gray-200">
            <div className='p-1 font-medium text-[14px] w-full text-white bg-green-600 xl:ps-[40%] px-2 sm:px-[10%] flex gap-2 items-center'>
                        ...
                        <div className='flex justify-end lg:justify-normal w-full'>
                            <div className='hidden w-full xl:flex'>
                                <div className='hidden w-full items-center justify-center gap-2 md:flex'>
                                    <li><a href="/about" className="block w-24 py-2 px-3 hover:text-green-500">About Us</a></li>
                                    <li className="relative group w-full"
                                        onMouseEnter={() => setIsServiceHovered(true)}
                                        onMouseLeave={() => setIsServiceHovered(false)}>
                                        <a href="#" className={`flex items-center justify-center py-2 px-3 ${isServiceHovered ? 'text-green-500' : 'text-black'}`}>
                                            Service
                                    ...
                                    <li><a href="/product" className="block py-2 px-3 hover:text-green-500">Products</a></li>
                                    <li><a href="/portfolio" className="block py-2 px-3 hover:text-green-500">Portfolio</a></li>
                                    <li className="relative group"
                                        onMouseEnter={() => setIsPricingHovered(true)}
                                        onMouseLeave={() => setIsPricingHovered(false)}>
                                        <a href="#" className={`flex items-center justify-center py-2 px-3 ${isPricingHovered ? 'text-green-500' : 'text-black'}`}
                                    ...
                                    <li className="relative group"
                                        ...
                                        <a href="#" className={`flex items-center justify-center py-2 px-3 ${isInsightsHovered ? 'text-green-500' : 'text-black'}`}>
                                            Insights
                                    ...
                                    <li><a href="/career" className="block py-2 px-3 hover:text-green-500">Career</a></li>
                                </div>
                            </div>
                            <div className='flex gap-2'>
                                <div className='xl:hidden flex items-center'>
                                    <div className='p-1 xl:hidden rounded-sm bg-green-500 text-white text-2xl'>
                ...
                <div className='flex items-center'>
                    {menuOpen && (
                        <div className="xl:hidden font-medium text-black">
                            <ul>
                                <li><a href="#" className="block py-2 px-3 hover:text-green-500">About Us</a></li>
                                <li className="relative group"
                                    onMouseEnter={() => setIsServiceHovered(true)}
                                    onMouseLeave={() => setIsServiceHovered(false)}>
                                    <a href="#" className={`flex items-center justify-between py-2 px-3 ${isServiceHovered ? 'text-green-500' : 'text-black'}`}>
                                        Service
                                        {isServiceHovered ? <FaCaretUp /> : <FaCaretDown />}
                                    </a>
                                    {isServiceHovered && (
                                ...
                                <li><a href="#" className="block py-2 px-3 hover:text-green-500">Products</a></li>
                                <li><a href="#" className="block py-2 px-3 hover:text-green-500">Portfolio</a></li>
                                <li className="relative group"
                                    onMouseEnter={() => setIsPricingHovered(true)}
                                    onMouseLeave={() => setIsPricingHovered(false)}>
                                    <a href="#" className={`flex items-center justify-between py-2 px-3 ${isPricingHovered ? 'text-green-500' : 'text-black'}`}>
                                        Pricing
                                        {isPricingHovered ? <FaCaretUp /> : <FaCaretDown />}
                                    </a>
                                    {isPricingHovered && (
                                ...
                                <li className="relative group"
                                    onMouseEnter={() => setIsInsightsHovered(true)}
                                    onMouseLeave={() => setIsInsightsHovered(false)}>
                                    <a href="#" className={`flex items-center justify-between py-2 px-3 ${isInsightsHovered ? 'text-green-500' : 'text-black'}`}>
                                        Insights
                                        {isInsightsHovered ? <FaCaretUp /> : <FaCaretDown />}
                                    </a>
                                    {isInsightsHovered && (
